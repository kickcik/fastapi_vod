...
from app.services.meeting_service_mysql import service_create_meeting_service
...
async def api_create_meeting_mysql() -> CreateMeetingResponse:
    return CreateMeetingResponse(url_code=(await service_create_meeting_service()).url_code)

@mysql_router.get('/{meeting_url_code}', description='meeting을 조회합니다.')
async def api_create_meeting_mysql(meeting_url_code: str) -> GetMeetingResponse:
